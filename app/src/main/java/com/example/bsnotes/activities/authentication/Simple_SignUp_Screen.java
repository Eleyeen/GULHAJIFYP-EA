...
import com.example.bsnotes.activities.models.User_Model;
...
public class Simple_SignUp_Screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simple__sign_up__screen);
                ...
                .addOnCompleteListener(Simple_SignUp_Screen.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent gotoDashbaord = new Intent(getApplicationContext(), SemesterActivity.class);
                            finish();
