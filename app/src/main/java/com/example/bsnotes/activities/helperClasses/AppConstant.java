...
public class AppConstant {
    ...
    public static final String SAVE_TO = "My Stories";
    ...
    public static final String JSON_KEY_SUB_TITLE = "sub_title";
    public static final String JSON_KEY_CATEGORY = "category";
    public static final String JSON_KEY_IMAGE_URL = "img_url";
    public static final String JSON_KEY_DETAILS = "details";


    public static final String TTS_LOCALE = "en-US";
